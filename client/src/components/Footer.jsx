export default function Footer(){
    return(
        <footer className="bg-white inset-shadow-2xl lg:h-4 sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
            ...
            <div className="flex justify-center items-center space-x-1">
                ...
                <a href="https://github.com/Luigazab/OJT" data-tooltip-target="tooltip-github" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
