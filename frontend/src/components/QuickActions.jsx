    ...
    return(
        <>
            ...
            <div className="grid grid-cols-2 gap-4 ">
                <a href="log-activity" className="flex flex-col items-center justify-center text-white bg-sky-950 hover:bg-gray-900 hover:text-amber-300 py-4 rounded-xl">
                ...
                <a href="schedule" className="flex flex-col items-center justify-center border border-gray-300 py-4 rounded-xl hover:bg-blue-50 hover:text-sky-900 hover:shadow-lg">
                ...
                <a href="customer" className="flex flex-col items-center justify-center border border-gray-300 py-4 rounded-xl hover:bg-blue-50 hover:text-sky-900 hover:shadow-lg">
                ...
                <a href="report" className="flex flex-col items-center justify-center border border-gray-300 py-4 rounded-xl hover:bg-blue-50 hover:text-sky-900 hover:shadow-lg">
